 ...
 */
public enum TargetLanguageText {
  AR("AR"),
  BG("BG"),
  CS("CS"),
  DA("DA"),
  ...
  TargetLanguageText(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static TargetLanguageText fromValue(String input) {
    for (TargetLanguageText b : TargetLanguageText.values()) {
